...
public class JmsProducerConsumer {
    ...
    public void enviarRecibir(String msg) {
        ...
        System.out.println("Municipalidad de Surco: Enviando " + msg);
        System.out.println("Municipalidad de Surco: Enviando con CorrId: " + id);
        ...
        String responseMessage = (String) jmsTemplate
                .receiveSelectedAndConvert(responseQueue,
                        "JMSCorrelationID='" + id + "'");
        System.out.println("Municipalidad de Surco RESPUESTA:" + responseMessage);
        System.out.println("Municipalidad de Surco RESPUESTA CORR ID:" + id);
    }
